...
`);
    ...
    case 'end': {
      ...
      if (sourcePath) {
        const today = new Date().toISOString().slice(0, 10);
        const archiveName = `${today}-archive.md`;
        ...
        console.log('  = 无 direction.md 或 focus-spec.md，跳过');
      }
      ...
      console.log('');
      if (sourcePath) {
        console.log('  归档: focus-spec-history/');
      }
      console.log('  描述新需求开始下一轮。');
      console.log('');
      break;
    }
